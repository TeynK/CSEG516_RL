...
class ActionType(Enum):
    ...
    RETURN_GEMS = "return_gems"     # Return excess gems
...
def get_legal_actions(board: Board, player: Player) -> List[Action]:
    ...
    NOTE: This function assumes the player is in a "NORMAL" state.
    Gem returning logic is handled *inside the Game* class.
    """
    # *** 수정: set() -> [] ***
